...
namespace EBZ.Mobile.ViewModels.Sales
{
    ...
    public class PaymentSuccessfulPageViewModel : INotifyPropertyChanged
    {
        #region Fields
        ...
        /// </summary>
        public PaymentSuccessfulPageViewModel()
        {
            this.ImagePath = "EmptyCart.svg";
            this.Header = "PAYMENT SUCCESSFUL";
            this.Content = "Payment notification has been sent to customer";
